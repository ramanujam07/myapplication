...
const Body = () => {
  ...
  return restList.length === 0 ? (
    ...
    <div className="bg-gray-100 ">
      <div className="m-4 px-4 flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="flex items-center md:ml-8">
          <input
            ...
            placeholder="Search"
            type="text"
            className="bg-gray-50 block w-full md:w-56 rounded-md px-2 py-2 ring-1 ring-inset ring-gray-400 focus:text-gray-800 mr-2 mb-2 md:mb-0"
            value={searchText}
        ...
        <div className=" hidden md:flex">
          ...
          <input
            ...
            type="text"
            className="bg-gray-50 block w-full md:w-56 rounded-md px-2 py-2 ring-1 ring-inset ring-gray-400 focus:text-gray-800"
            value={loggedInUser}
      ...
      <div className="bg-gray-50 m-4 p-4 flex flex-wrap justify-center">
